...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        patches = image.view(B, C, H // patch_h, patch_h, W // patch_w, patch_w)
        ...
        """
        patches = rearrange(patches, 'b c numh ph numw pw -> b (numh numw) c ph pw')
        #patches.permute(0, 2, 4, 1, 3, 5).reshape(B, num_patches, C, patch_h, patch_w)
    else:
        """
